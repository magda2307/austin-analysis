...
| Name status | `has_name`, `is_named` | Proxy for prior ownership |
| Age | `age_upon_intake`, `age_days`, `age_months`, `age_years`, `age_group` | H3 evidence |
| Intake circumstances | `intake_type`, `intake_condition` | H1 evidence |
| Timing | `intake_year`, `intake_month`, `intake_quarter`, `intake_season`, `covid_period` | H2, H5 evidence |
