...
\hline
Dopasowane epizody z targetem & 162 355 & 1 525 \\
\hline
Finalny zbiór modelowy & 162 355 & 0 \\
\hline
\end{tabular}
\end{table}
...
Zbiór obejmujący 162 355 pobytów pozwala przedstawić podstawowe statystyki opisowe. Najważniejsze wskaźniki zmieniały się w czasie:
...
\label{fig:ch3_adoptions_by_year}
\end{figure}
...
W wyniku opisanych przekształceń utworzono finalny zbiór modelowy obejmujący 162 355 epizodów pobytu psów i kotów w Austin Animal Center. Każdy rekord reprezentuje pojedyncze przyjęcie zwierzęcia, zestaw cech znanych w momencie tego przyjęcia oraz chronologicznie dopasowany wynik końcowy. Taka konstrukcja pozwala analizować proces pobytu z perspektywy informacji dostępnych przed rozstrzygnięciem sprawy zwierzęcia, a jednocześnie ogranicza ryzyko wycieku danych z przyszłości.
