...
\ChapterEightFigure{../reports/figures/vulnerable_profiles.png}{%
  Syntetyczny obraz profili zwierząt szczególnie narażonych na długoterminowy pobyt
  w~schronisku, wyznaczonych przez model predykcyjny. Grupy te stanowią priorytet
  dla interwencji opisanych w~rekomendacjach praktycznych.}{%
